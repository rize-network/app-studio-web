  ...
  const tabs = [
    {
      ...
      content: (
        <View padding={20}>
          <Text fontSize="lg" fontWeight="bold">Home Content</Text>
    ...
    },
    {
      ...
      content: (
        <View padding={20}>
          <Text fontSize="lg" fontWeight="bold">Profile Content</Text>
    ...
    },
    {
      ...
      content: (
        <View padding={20}>
          <Text fontSize="lg" fontWeight="bold">Settings Content</Text>
