...
export const Features = [
  ...
  },
  {
    ...
    description: 'Enhance commit consistency and maintainability.',
    icon: (
      <svg
        height="24px"
        width="24px"
  ...
  },
  {
    ...
    description: 'Embrace better code quality and stylish formatting.',
    icon: (
      <svg
        height="24px"
        width="24px"
  ...
  },
  {
    ...
    description: 'Fortify your codebase and enhance development confidence.',
    icon: (
      <svg
        height="24px"
        width="24px"
...

  {
    ...
    description: 'Ensure reliable and comprehensive testing coverage',
    icon: (
      <svg
        height="24px"
        width="24px"
