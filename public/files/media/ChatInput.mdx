...
A customizable chat input component with support for file uploads, prompt examples, and reference images.
...
The ChatInput component exposes the following methods via a ref:
