...
A powerful chat input component with comprehensive file upload support, drag & drop functionality, and multiple interaction modes. Built with the integrated Uploader component for seamless file handling and attachment management.
