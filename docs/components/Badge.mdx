...
### **Import**
```tsx
import { Badge } from '@app-studio/components';
```
...
import { Badge } from '@app-studio/components';
import { Variant } from '@app-studio/components';
...
import { Position } from '@app-studio/components';
...
import { Badge } from '@app-studio/components';
import { Size } from '@app-studio/components';
import { View } from 'app-studio';
...
import { Horizontal } from 'app-studio';
import { Badge } from '@app-studio/components';
import { Shape } from '@app-studio/components';
import { View } from 'app-studio';
