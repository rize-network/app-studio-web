...
> **React Native:** `FormikForm` renders through the native `Form` primitive,
> which is a `View`, not a browser form. Keep `type="submit"`/`type="reset"` for
> web semantics and also wire `onClick={handleSubmit}` or
> `onClick={handleReset}` explicitly. With `autoFocus`, single-line
> fields use `returnKeyType`/`onSubmitEditing` to advance and submit; labels,
> validation, and accessibility still need their native component wiring.

### **Import**
  ```tsx
  import { FormikForm, FormikTextField, FormikCheckbox, FormikChatInput, FormikColorInput, FormikSelect, FormikSwitch, FormikTextArea, FormikDatePicker, FormikCountryPicker, FormikPassword, FormikComboBox, FormikSlider, FormikIconPicker, FormikEmojiPicker, FormikOTPInput, FormikRadio, FormikSelector, FormikTagInput, FormikToggle, FormikToggleGroup, FormikUploader } from '@app-studio/components';
  ```
...
import { FormikForm } from '@app-studio/components';
import { FormikTextField } from '@app-studio/components';
import { FormikCheckbox } from '@app-studio/components';
...
import * as Yup from 'yup';
import { FormikForm } from '@app-studio/components';
import { FormikTextArea } from '@app-studio/components';
import { Button } from '@app-studio/components';
...
import * as Yup from 'yup';
import { FormikForm } from '@app-studio/components';
import { FormikChatInput } from '@app-studio/components';
import { Button, Vertical, Text } from '@app-studio/components';
...
import * as Yup from 'yup';
import { FormikForm } from '@app-studio/components';
import { FormikColorInput } from '@app-studio/components';
import { Button } from '@app-studio/components';
...
import * as Yup from 'yup';
import { FormikForm } from '@app-studio/components';
import { FormikSelect } from '@app-studio/components';
import { Button } from '@app-studio/components';
...
import { Formik } from 'formik';
import { FormikForm } from '@app-studio/components';
import { FormikSwitch } from '@app-studio/components';
import { Button } from '@app-studio/components';
...
import * as Yup from 'yup';
import { FormikForm } from '@app-studio/components';
import { FormikDatePicker } from '@app-studio/components';
import { Button } from '@app-studio/components';
...
import * as Yup from 'yup';
import { FormikForm } from '@app-studio/components';
import { FormikCountryPicker } from '@app-studio/components';
import { Button } from '@app-studio/components';
...
import * as Yup from 'yup';
import { FormikForm } from '@app-studio/components';
import { FormikPassword } from '@app-studio/components';
import { Button } from '@app-studio/components';
...
import * as Yup from 'yup';
import { FormikForm } from '@app-studio/components';
import { FormikComboBox } from '@app-studio/components';
import { Button } from '@app-studio/components';
...
import * as Yup from 'yup';
import { FormikForm } from '@app-studio/components';
import { FormikSlider } from '@app-studio/components';
import { Button } from '@app-studio/components';
...
import React from 'react';
import { Formik } from 'formik';
import { FormikForm, FormikIconPicker, Button } from '@app-studio/components';
...
import React from 'react';
import { Formik } from 'formik';
import { FormikForm, FormikEmojiPicker, Button } from '@app-studio/components';
...
import React from 'react';
import { Formik } from 'formik';
import { FormikForm, FormikOTPInput, Button } from '@app-studio/components';
...
import React from 'react';
import { Formik } from 'formik';
import { FormikForm, FormikRadio, Button } from '@app-studio/components';
...
import React from 'react';
import { Formik } from 'formik';
import { FormikForm, FormikSelector, Button } from '@app-studio/components';
...
import React from 'react';
import { Formik } from 'formik';
import { FormikForm, FormikTagInput, Button } from '@app-studio/components';
...
import React from 'react';
import { Formik } from 'formik';
import { FormikForm, FormikToggle, Button } from '@app-studio/components';
...
import React from 'react';
import { Formik } from 'formik';
import { FormikForm, FormikToggleGroup, Button } from '@app-studio/components';
...
import React from 'react';
import { Formik } from 'formik';
import { FormikForm, FormikUploader, Button } from '@app-studio/components';
