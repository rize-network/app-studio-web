...
### **Import**
  ```tsx
  import { Center } from '@app-studio/components';
  // or from app-studio
  import { Center } from '@app-studio/components';
  ```
...
import { Center } from '@app-studio/components';
import { Text } from '@app-studio/components';
...
import React from 'react';
import { Center } from '@app-studio/components';
import { Loader } from '@app-studio/components';
import { Text, Vertical } from '@app-studio/components';
...
import { Text, Vertical } from '@app-studio/components';
import { FolderIcon } from '@app-studio/components';
...
import React from 'react';
import { Center } from '@app-studio/components';
import { Modal, Button } from '@app-studio/components';
import { Text, Vertical, Horizontal } from '@app-studio/components';
...
import React from 'react';
import { Center } from '@app-studio/components';
import { View, Text, Vertical } from '@app-studio/components';
import { StarIcon } from '@app-studio/components';
...
import React from 'react';
import { Center } from '@app-studio/components';
import { View } from '@app-studio/components';
...
import { Button } from '@app-studio/components';
import { Text, Vertical } from '@app-studio/components';
import { ErrorIcon } from '@app-studio/components';
...
import { Center } from '@app-studio/components';
import { Text } from '@app-studio/components';
import { ImageIcon } from '@app-studio/components';
...
- On web, consider CSS Grid for complex centered layouts. On React Native,
  `Grid` supports only fixed integer columns faithfully; use explicit flex rows
  when content needs intrinsic sizing or spanning.
...
```tsx
import { Center, Vertical, Horizontal } from '@app-studio/components';
