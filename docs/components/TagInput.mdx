...
### **Import**
  ```tsx
  import { TagInput } from '@app-studio/components';
  ```

### **Default**
```tsx
import React, { useState } from 'react';
import { Vertical, Text } from '@app-studio/components';
import { TagInput } from '@app-studio/components';
...
import { Vertical } from '@app-studio/components';
import { TagInput } from '@app-studio/components';
import { SearchIcon, TagIcon } from '@app-studio/components';
...
```tsx
import React, { useState } from 'react';
import { Vertical, Button } from '@app-studio/components';
import { TagInput } from '@app-studio/components';
