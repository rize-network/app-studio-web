...
import { Vertical } from '@app-studio/components';
import { View, Text } from '@app-studio/components';
...
import React from 'react';
import { Vertical } from '@app-studio/components';
import { TextField, Button, Checkbox } from '@app-studio/components';
...
import React from 'react';
import { Vertical } from '@app-studio/components';
import { View, Text, Horizontal } from '@app-studio/components';
import { HomeIcon, UserIcon, SettingsIcon, LogoutIcon } from '@app-studio/components';
...
import { StarIcon, HeartIcon, ShareIcon } from '@app-studio/components';
...
- On web, use CSS Grid for complex layouts instead of deeply nested flex
  containers. On React Native, `Grid` is portable only with a fixed integer
  column count; use explicit `Horizontal` rows or a virtualised `FlatList` for
  intrinsic sizing, spanning, or scrollable collections.
...
```tsx
import { Vertical, Horizontal, Center } from '@app-studio/components';
