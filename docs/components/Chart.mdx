...
### **Import**
```tsx
import { Chart, CHART_COLORS } from '@app-studio/components';
```

### **Quick Start (Bar Chart)**
```tsx
import React from 'react';
import { Chart, CHART_COLORS, View } from '@app-studio/components';
...
import { Chart, Button, Vertical, Horizontal } from '@app-studio/components';
