...
### **Import**
```tsx
import { Tooltip } from '@app-studio/components';
```
...
import React from 'react';
import { Tooltip } from '@app-studio/components';
import { InfoIcon } from '@app-studio/components';
...
import { Tooltip } from '@app-studio/components';
import { Button, Horizontal } from 'app-studio';
import { EditIcon, DeleteIcon, ShareIcon } from '@app-studio/components';
...
import React from 'react';
import { Tooltip } from '@app-studio/components';
import { StatusIndicator } from '@app-studio/components';
